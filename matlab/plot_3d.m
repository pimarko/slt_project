...
for i = 1:n
    ...
    if voxel_count(cluster_index) > 0
...
% 3d scatter plot
colors = repmat(linspace(1,255,nO_clusters)', 3);
scatter3(clrd_coordinates(:, 1), clrd_coordinates(:, 2), clrd_coordinates(:, 3), 400, colors(clrd_clusters), 'filled', 'square');